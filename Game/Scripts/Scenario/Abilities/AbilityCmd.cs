...
public static class AbilityCmd
{
	...
	public static async GDTask GenericChoice(Figure authority, IEnumerable<ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.Subscription> subscriptions,
		bool canSelectMultiple = false, string hintText = "Make a selection")
	{
		object subscriber = new object();
		foreach(ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.Subscription subscription in subscriptions)
		{
			ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.CanApplyFunction oldCanApplyFunction = subscription.CanApplyFunction;
			ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.CanApplyFunction newCanApplyFunction = parameters =>
			{
				return
			...
			ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.ApplyFunction oldApplyFunction = subscription.ApplyFunction;
			ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.ApplyFunction newApplyFunction = async parameters =>
			{
			...
			ScenarioEvent<ScenarioEvents.GenericChoice.Parameters>.Subscription newSubscription =
